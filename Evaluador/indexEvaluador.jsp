    ...
    <table class="table">
        ...
        <tbody>
            <sql:query var="result" dataSource="${universidad}">
                SELECT * FROM usuarios WHERE tipo_usuario = 'Evaluador'
            </sql:query>
            <c:forEach var="row" items="${result.rows}">
                <tr>
                    ...
                    <td>
                        <a class="btn btn-warning" href="actualizarEvaluador.jsp?id=${row.id_usuario}">Editar</a>
                        
                        <a class="btn btn-danger" href="eliminarEvaluador.jsp?id=${row.id_usuario}">Eliminar</a>
                    </td>
                </tr>
            </c:forEach>
        </tbody>
