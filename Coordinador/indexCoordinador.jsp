...
<div class="container mt-5">
    ...
    <h2 class="text-center">Listado de Coordinadores</h2>
    ...
    <table class="table">
        ...
        <tbody>
            <sql:query var="result" dataSource="${universidad}">
                SELECT * FROM usuarios WHERE tipo_usuario = 'Coordinador'
            </sql:query>
            <c:forEach var="row" items="${result.rows}">
                <tr>
                    ...
                    <td>
                        <a class="btn btn-warning" href="actualizarCoordinador.jsp?id=${row.id_usuario}">Editar</a>
                        
                        <a class="btn btn-danger" href="eliminarCoordinador.jsp?id=${row.id_usuario}">Eliminar</a>
                    </td>
                </tr>
            </c:forEach>
        </tbody>
