...
<div class="container my-4">
    <h1 class="text-center">Administrar Proyectos</h1>
    <div class="row text-center justify-content-center">
        <div class="col-md-6 text-center mr-5">
            <h2 class="mb-5">Lista de Opciones</h2>
            <div class="list-group text-center">
                <a href="./adminProyectos/agregarProyecto.jsp" class="list-group-item list-group-item-action">Crear Proyecto</a>
                <a href="buscarProyecto.jsp" class="list-group-item list-group-item-action">Buscar Proyecto del Estudiante</a>
