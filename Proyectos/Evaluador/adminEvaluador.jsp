...
<div class="container my-4">
    <h1 class="text-center">Administrar Evaluador</h1>
    <div class="row text-center justify-content-center">
        <div class="col-md-6 text-center mr-5">
            <h2 class="mb-5">Lista de Opciones</h2>
            <div class="list-group text-center">
                <a href="evaluarProyectos.jsp" class="list-group-item list-group-item-action">Aprovacion de Proyectos</a>
                ...
                <a href="https://drive.google.com/drive/folders/1Kqi8ow1qs-uLurSDGcv56d1Jt4-u66rB?usp=drive_link" target="_blank" class="list-group-item list-group-item-action">Consultar Formatos de Grado</a>
            </div>
        </div>
        <div class="col-md-6">
