...
<div class="container my-4">
    <h1 class="text-center">Calificar Proyecto</h1>
    <div class="row justify-content-center">
        <div class="col-md-6">
            ...
            <p class="alert alert-success">Calificación guardada exitosamente.</p>
            <p><a href="adminDirector.jsp" class="btn btn-primary">Volver al Menú Principal</a></p>
        </div>
    </div>
</div>
