...
<head>
    ...
    <title>Buscar Proyecto por Usuario</title>
    <!-- Bootstrap CSS -->
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="adminEstudiante.jsp">Administrar Proyectos</a>
                </li>
                <li class="nav-item">
...
<div class="container my-4 ">
    ...
    <c:if test="${sessionScope.loggedUser != null}">
        <sql:query var="proyectosUsuario" dataSource="${universidad}">
            ...
            WHERE 
                CASE 
                    WHEN '${sessionScope.loggedUser.tipo}' = 'estudiante' THEN
                        p.id_estudiante = '${sessionScope.loggedUser.id_usuario}' 
                    WHEN '${sessionScope.loggedUser.tipo}' = 'director' THEN
                        p.id_director = '${sessionScope.loggedUser.id_usuario}' 
                    ELSE
                        p.id_evaluador = '${sessionScope.loggedUser.id_usuario}' 
                END;
        </sql:query>
        ...
        <div class="mt-4">
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <p>No se encontraron proyectos asignados para el usuario logueado.</p>
                </c:otherwise>
            </c:choose>
        </div>
    </c:if>
