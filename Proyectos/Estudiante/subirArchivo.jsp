...
<body>
    <div class="container mt-5">
        ...
        <form action="guardarArchivo.jsp" method="post">
            <input type="hidden" name="id_proyecto" value="${param.id}">
            <div class="form-group">
                <label for="enlace">Enlace del archivo:</label>
                <input type="text" class="form-control" id="enlace" name="enlace">
            </div>
            <button type="submit" class="btn btn-primary">Subir Enlace</button>
        </form>
    </div>
