...
<div class="container my-4">
    <h1 class="text-center">Administrar Estudiante</h1>
    <div class="row text-center justify-content-center">
        <div class="col-md-6 text-center mr-5">
            <h2 class="mb-5">Lista de Proyectos</h2>
            <div class="list-group text-center">
                <a href="seleccionarIdeaProyecto.jsp" class="list-group-item list-group-item-action">Seleccionar Proyecto</a>
                <%-- <a href="proyectosEstudiante.jsp" class="list-group-item list-group-item-action">Ver mis Proyectos</a> --%>
