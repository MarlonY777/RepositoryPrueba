        ...
        <tbody>
            ...
            <c:forEach var="row" items="${result.rows}">
                <tr>
                    ...
                    <td>
                        <a class="btn btn-warning" href="actualizarEstudiante.jsp?id=${row.id_usuario}">Editar</a>
                        
                        <a class="btn btn-danger" href="eliminarEstudiante.jsp?id=${row.id_usuario}">Eliminar</a>
                    </td>
                </tr>
            </c:forEach>
        </tbody>
